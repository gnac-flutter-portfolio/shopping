                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        FadeAnimation(1.2, Text(widget.title, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 40),))
                      ],
                    ),
                  ),
                ),
            ...
            Row(
              ...
              children: <Widget>[
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    FadeAnimation(1.5, Text(title, style: const TextStyle(color: Colors.white, fontSize: 20),)),
                    FadeAnimation(1.6, Text(price, style: const TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.bold),)),
                  ],
                ),
